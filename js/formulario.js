(function () {
  ...
  function applyPageMessages() {
    if (error === 'credenciales') {
      ...
      showAlert('No se pudo conectar a la base de datos. Importa primero el archivo banco_provincia.sql en phpMyAdmin.');
    } else if (params.get('registro') === 'ok') {
      showAlert('Cuenta creada correctamente. Ahora podes iniciar sesion.');
    } else if (params.get('logout') === '1') {
      showAlert('La sesion se cerro correctamente.');
    }
  }
